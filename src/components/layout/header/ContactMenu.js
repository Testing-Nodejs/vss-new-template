        ...
        <div className="hamburger_wrapper">
          <div className="hamburger_inner">
            <div className="hamburger_top d-flex align-items-center justify-content-between">
              <div className="hamburger_logo">
                <Link href="/" className="mobile_logo">
                  <img src="/images/logos/Veriteam_Logo.png" alt="Logo" />
                </Link>
              </div>
            ...
            <div className="offcanvas-text">
              <p>
                VSS — Trusted Solutions for Software Automation & Empowering
                Businesses with Intelligent Technology & Crafting Smarter
                Digital Experience.
              </p>
            </div>
            ...
            <div className="hamburger-infos">
              ...
              <div className="contact-info">
                <div className="contact-item">
                  ...
                  <Link className="contact-link" href="tel:919986019715">
                    +91 9986019715
                  </Link>
                </div>
                <div className="contact-item">
